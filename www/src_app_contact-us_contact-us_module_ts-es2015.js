...
let ContactUsPage = class ContactUsPage {
    constructor(navCtrl, http, config, loading, shared, appHttpService, appToastService, appUserService) {
    ...
    submit() {
        ...
        this.appHttpService.postHttp('contact-us', info, true).then((data) => {
            if (this.appUserService.userIsLogedIn()) {
...
ContactUsPage = (0,tslib__WEBPACK_IMPORTED_MODULE_11__.__decorate)([
...
//# sourceMappingURL=src_app_contact-us_contact-us_module_ts-es2015.js.map