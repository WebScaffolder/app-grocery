(function () {
  ...
  (self["webpackChunkrawal"] = self["webpackChunkrawal"] || []).push([["src_app_my-order-detail_my-order-detail_module_ts"], {
    /***/
    29192:
    /*!***********************************************************!*\
    ...
    function _(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        ...
        /* harmony export */
        "registerDatabase": function registerDatabase() {
          return (
            /* binding */
            _registerDatabase
          );
      ...
      var _enableLogging = function _enableLogging(logger_, persistent) {
        ...
        BrowserPollConnection.prototype.open = function (onMessage, onDisconnect) {
          ...
          executeWhenDOMReady(function () {
            ...
            _this.scriptTagHolder = new FirebaseIFrameScriptHolder(function () {
              ...
              var _a = (0, tslib__WEBPACK_IMPORTED_MODULE_4__.__read)(args, 5),
                  command = _a[0],
                  arg1 = _a[1],
                  arg2 = _a[2];
              ...
              var _a = (0, tslib__WEBPACK_IMPORTED_MODULE_4__.__read)(args, 2),
                  pN = _a[0],
                  data = _a[1];
      ...
      function () {
        ...
        WebSocketConnection.connectionURL_ = function (repoInfo, transportSessionId, lastSessionId, appCheckToken) {
          ...
          if (!(0, _firebase_util__WEBPACK_IMPORTED_MODULE_2__.isNodeSdk)() && typeof location !== 'undefined' && location.hostname && FORGE_DOMAIN_RE.test(location.hostname)) {
            urlParams[REFERER_PARAM] = FORGE_REF;
          }
        ...
        WebSocketConnection.prototype.appendFrame_ = function (data) {
          ...
          if (this.frames.length === this.totalFrames) {
            ...
            this.frames = null;
            var jsonMess = (0, _firebase_util__WEBPACK_IMPORTED_MODULE_2__.jsonEval)(fullMess); //handle the message
        ...
        WebSocketConnection.prototype.extractFrameCount_ = function (data) {
          (0, _firebase_util__WEBPACK_IMPORTED_MODULE_2__.assert)(this.frames === null, 'We already have a frame buffer'); // TODO: The server is only supposed to send up to 9999 frames (i.e. length <= 4), but that isn't being enforced
      ...
      function (_super) {
        ...
        function OnlineMonitor() {
          ...
          if (typeof window !== 'undefined' && typeof window.addEventListener !== 'undefined' && !(0, _firebase_util__WEBPACK_IMPORTED_MODULE_2__.isMobileCordova)()) {
      ...
      function validationPathPop(validationPath) {
        ...
        validationPath.byteLength_ -= (0, _firebase_util__WEBPACK_IMPORTED_MODULE_2__.stringLength)(last); // Un-count the previous '/'
      ...
      function (_super) {
        ...
        PersistentConnection.prototype.onDataPush_ = function (action, body) {
          ...
          if (action === 'd') {
            ...
            error('Unrecognized action received from server: ' + (0, _firebase_util__WEBPACK_IMPORTED_MODULE_2__.stringify)(action) + '\nAre you using the latest client?');
          }
        };
      ...
      function (_super) {
        ...
        KeyIndex.prototype.makePost = function (indexValue, name) {
          (0, _firebase_util__WEBPACK_IMPORTED_MODULE_2__.assert)(typeof indexValue === 'string', 'KeyIndex indexValue must always be a string.'); // We just use empty node, but it'll never be compared, since our comparator only looks at name.
      ...
      var validatePriorityNode = function validatePriorityNode(priorityNode) {
        if (priorityNode.isLeafNode()) {
          ...
          (0, _firebase_util__WEBPACK_IMPORTED_MODULE_2__.assert)(typeof val === 'string' || typeof val === 'number' || typeof val === 'object' && (0, _firebase_util__WEBPACK_IMPORTED_MODULE_2__.contains)(val, '.sv'), 'Priority must be a string or number.');
        } else {
      ...
      function nodeFromJSON(json, priority) {
        ...
        (0, _firebase_util__WEBPACK_IMPORTED_MODULE_2__.assert)(priority === null || typeof priority === 'string' || typeof priority === 'number' || typeof priority === 'object' && '.sv' in priority, 'Invalid priority type found: ' + typeof priority);
      ...
      function queryParamsToRestQueryStringParameters(queryParams) {
        ...
        qs["orderBy"
        /* ORDER_BY */
        ] = (0, _firebase_util__WEBPACK_IMPORTED_MODULE_2__.stringify)(orderBy);

        if (queryParams.startSet_) {
          qs["startAt"
          /* START_AT */
          ] = (0, _firebase_util__WEBPACK_IMPORTED_MODULE_2__.stringify)(queryParams.indexStartValue_);
        ...
        if (queryParams.endSet_) {
          qs["endAt"
          /* END_AT */
          ] = (0, _firebase_util__WEBPACK_IMPORTED_MODULE_2__.stringify)(queryParams.indexEndValue_);
      ...
      function (_super) {
        ...
        ReadonlyRestClient.prototype.restRequest_ = function (pathString, queryStringParameters, callback) {
          ...
          false)]).then(function (_a) {
            ...
            var url = (_this.repoInfo_.secure ? 'https://' : 'http://') + _this.repoInfo_.host + pathString + '?' + 'ns=' + _this.repoInfo_.namespace + (0, _firebase_util__WEBPACK_IMPORTED_MODULE_2__.querystring)(queryStringParameters);
      ...
      function () {
        ...
        AckUserWrite.prototype.operationForChild = function (childName) {
          if (!pathIsEmpty(this.path)) {
            ...
            (0, _firebase_util__WEBPACK_IMPORTED_MODULE_2__.assert)(this.affectedTree.children.isEmpty(), 'affectedTree should not have overlapping affected paths.'); // All child locations are affected as well; just return same operation.
      ...
      function () {
        ...
        ChildChangeAccumulator.prototype.trackChildChange = function (change) {
          ...
          (0, _firebase_util__WEBPACK_IMPORTED_MODULE_2__.assert)(type === "child_added"
          /* CHILD_ADDED */
          || type === "child_changed"
          /* CHILD_CHANGED */
          || type === "child_removed"
          ...
          if (oldChange) {
            ...
            /* CHILD_CHANGED */
              ...
              throw (0, _firebase_util__WEBPACK_IMPORTED_MODULE_2__.assertionError)('Illegal combination of changes: ' + change + ' occurred after ' + oldChange);
            }
          } else {
      ...
      function viewProcessorApplyOperation(viewProcessor, oldViewCache, operation, writesCache, completeCache) {
        ...
        if (operation.type === OperationType.OVERWRITE) {
          ...
          if (overwrite.source.fromUser) {
            ...
            (0, _firebase_util__WEBPACK_IMPORTED_MODULE_2__.assert)(overwrite.source.fromServer, 'Unknown source.'); // We filter the node if it's a tagged update or the node has been previously filtered  and the
          ...
          if (merge.source.fromUser) {
            ...
            (0, _firebase_util__WEBPACK_IMPORTED_MODULE_2__.assert)(merge.source.fromServer, 'Unknown source.'); // We filter the node if it's a tagged update or the node has been previously filtered
      ...
      function viewApplyOperation(view, operation, writesCache, completeServerCache) {
        ...
        (0, _firebase_util__WEBPACK_IMPORTED_MODULE_2__.assert)(result.viewCache.serverCache.isFullyInitialized() || !oldViewCache.serverCache.isFullyInitialized(), 'Once a server snap is complete, it should never go back');
        ...
        if (queryId === 'default') {
          try {
            ...
            for (var _b = (0, tslib__WEBPACK_IMPORTED_MODULE_4__.__values)(syncPoint.views.entries()), _c = _b.next(); !_c.done; _c = _b.next()) {
              var _d = (0, tslib__WEBPACK_IMPORTED_MODULE_4__.__read)(_c.value, 2),
                  viewQueryId = _d[0],
                  view = _d[1];
      ...
      var resolveComplexDeferredValue = function resolveComplexDeferredValue(op, existing, unused) {
        ...
        (0, _firebase_util__WEBPACK_IMPORTED_MODULE_2__.assert)(existingNode !== null && typeof existingNode !== 'undefined', 'Expected ChildrenNode.EMPTY_NODE for nulls'); // Incrementing a non-number sets the value to the incremented amount
      ...
      var validateFirebaseData = function validateFirebaseData(errorPrefix, data, path_) {
        ...
        if (typeof data === 'string' && data.length > MAX_LEAF_SIZE_ / 3 && (0, _firebase_util__WEBPACK_IMPORTED_MODULE_2__.stringLength)(data) > MAX_LEAF_SIZE_) {
      ...
      var validatePriority = function validatePriority(fnName, priority, optional) {
        ...
        if (isInvalidJSONNumber(priority)) {
          throw new Error((0, _firebase_util__WEBPACK_IMPORTED_MODULE_2__.errorPrefix)(fnName, 'priority') + 'is ' + priority.toString() + ', but must be a valid Firebase priority (a string, finite number, ' + 'server value, or null).');
        } // Special case to allow importing data with a .sv.


        if (!isValidPriority(priority)) {
          throw new Error((0, _firebase_util__WEBPACK_IMPORTED_MODULE_2__.errorPrefix)(fnName, 'priority') + 'must be a valid Firebase priority ' + '(a string, finite number, server value, or null).');
        }
      };
      ...
      var validateEventType = function validateEventType(fnName, eventType, optional) {
        ...
        switch (eventType) {
          ...
          default:
            throw new Error((0, _firebase_util__WEBPACK_IMPORTED_MODULE_2__.errorPrefix)(fnName, 'eventType') + 'must be a valid event type = "value", "child_added", "child_removed", ' + '"child_changed", or "child_moved".');
        }
      };
      ...
      var validateKey = function validateKey(fnName, argumentName, key, optional) {
        ...
        if (!isValidKey(key)) {
          throw new Error((0, _firebase_util__WEBPACK_IMPORTED_MODULE_2__.errorPrefix)(fnName, argumentName) + 'was an invalid key = "' + key + '".  Firebase keys must be non-empty strings and ' + 'can\'t contain ".", "#", "$", "/", "[", or "]").');
        }
      };
      ...
      var validatePathString = function validatePathString(fnName, argumentName, pathString, optional) {
        ...
        if (!isValidPathString(pathString)) {
          throw new Error((0, _firebase_util__WEBPACK_IMPORTED_MODULE_2__.errorPrefix)(fnName, argumentName) + 'was an invalid path = "' + pathString + '". Paths must be non-empty strings and ' + 'can\'t contain ".", "#", "$", "[", or "]"');
        }
      };
      ...
      var validateUrl = function validateUrl(fnName, parsedUrl) {
        ...
        if (!(typeof parsedUrl.repoInfo.host === 'string') || parsedUrl.repoInfo.host.length === 0 || !isValidKey(parsedUrl.repoInfo.namespace) && parsedUrl.repoInfo.host.split(':')[0] !== 'localhost' || pathString.length !== 0 && !isValidRootPathString(pathString)) {
          throw new Error((0, _firebase_util__WEBPACK_IMPORTED_MODULE_2__.errorPrefix)(fnName, 'url') + 'must be a valid firebase URL and ' + 'the path can\'t contain ".", "#", "$", "[", or "]".');
        }
      };
      ...
      function repoOnDataUpdate(repo, pathString, data, isMerge, tag) {
        ...
        if (tag) {
          if (isMerge) {
            var taggedChildren = (0, _firebase_util__WEBPACK_IMPORTED_MODULE_2__.map)(data, function (raw) {
          ...
          var changedChildren = (0, _firebase_util__WEBPACK_IMPORTED_MODULE_2__.map)(data, function (raw) {
            return nodeFromJSON(raw);
          });
      ...
      function repoStartTransaction(repo, path, transactionUpdate, onComplete, unwatcher, applyLocally) {
        ...
        if (newVal === undefined) {
          ...
          if (typeof newVal === 'object' && newVal !== null && (0, _firebase_util__WEBPACK_IMPORTED_MODULE_2__.contains)(newVal, '.priority')) {
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            priorityForNode = (0, _firebase_util__WEBPACK_IMPORTED_MODULE_2__.safeGet)(newVal, '.priority');
            (0, _firebase_util__WEBPACK_IMPORTED_MODULE_2__.assert)(isValidPriority(priorityForNode), 'Invalid priority returned by transaction. ' + 'Priority must be a valid string, finite number, server value, or null.');
          } else {
      ...
      function repoSendTransactionQueue(repo, path, queue) {
        ...
        for (var i = 0; i < queue.length; i++) {
          var txn = queue[i];
          (0, _firebase_util__WEBPACK_IMPORTED_MODULE_2__.assert)(txn.status === 0
          /* RUN */
          ...
          /* RUN */
            ...
            if (transaction.retryCount >= MAX_TRANSACTION_RETRIES) {
              ...
              if (newData !== undefined) {
                ...
                var hasExplicitPriority = typeof newData === 'object' && newData != null && (0, _firebase_util__WEBPACK_IMPORTED_MODULE_2__.contains)(newData, '.priority');
        ...
        if (queue) {
          ...
          for (var i = 0; i < queue.length; i++) {
            ...
            /* SENT */
              ...
              (0, _firebase_util__WEBPACK_IMPORTED_MODULE_2__.assert)(queue[i].status === 0
              /* RUN */
      ...
      function () {
        ...
        DataEvent.prototype.toString = function () {
          return this.getPath().toString() + ':' + this.eventType + ':' + (0, _firebase_util__WEBPACK_IMPORTED_MODULE_2__.stringify)(this.snapshot.exportVal());
        };
      ...
      function validateQueryEndpoints(params) {
        ...
        if (params.getIndex() === KEY_INDEX) {
          ...
          (0, _firebase_util__WEBPACK_IMPORTED_MODULE_2__.assert)(params.getIndex() instanceof PathIndex || params.getIndex() === VALUE_INDEX, 'unknown index type.');
      ...
      function connectDatabaseEmulator(db, host, port, options) {
        ...
        if (repo.repoInfo_.nodeAdmin) {
          ...
          var token = typeof options.mockUserToken === 'string' ? options.mockUserToken : (0, _firebase_util__WEBPACK_IMPORTED_MODULE_2__.createMockUserToken)(options.mockUserToken, db.app.options.projectId);
      ...
      function () {
        ...
        DataSnapshot.prototype.child = function (path) {
          (0, _firebase_util__WEBPACK_IMPORTED_MODULE_2__.validateArgCount)('DataSnapshot.child', 0, 1, arguments.length); // Ensure the childPath is a string (can be a number)
        ...
        DataSnapshot.prototype.getRef = function () {
          ...
          return new _Reference(this._database, this._delegate.ref);
        };
      ...
      function () {
        ...
        Query.prototype.on = function (eventType, callback, cancelCallbackOrContext, context) {
          ...
          var valueCallback = function valueCallback(expSnapshot, previousChildName) {
            callback.call(ret.context, new _DataSnapshot(_this.database, expSnapshot), previousChildName);
          };
          ...
          switch (eventType) {
            ...
            default:
              throw new Error((0, _firebase_util__WEBPACK_IMPORTED_MODULE_2__.errorPrefix)('Query.on', 'eventType') + 'must be a valid event type = "value", "child_added", "child_removed", ' + '"child_changed", or "child_moved".');
          }
        };
        ...
        Query.prototype.get = function () {
          ...
          return get(this._delegate).then(function (expSnapshot) {
            return new _DataSnapshot(_this.database, expSnapshot);
          });
        };
        /**
        ...
        Query.prototype.once = function (eventType, callback, failureCallbackOrContext, context) {
          ...
          var valueCallback = function valueCallback(expSnapshot, previousChildName) {
            var result = new _DataSnapshot(_this.database, expSnapshot);
          ...
          switch (eventType) {
            ...
            default:
              throw new Error((0, _firebase_util__WEBPACK_IMPORTED_MODULE_2__.errorPrefix)('Query.once', 'eventType') + 'must be a valid event type = "value", "child_added", "child_removed", ' + '"child_changed", or "child_moved".');
          }
        ...
        Query.getCancelAndContextArgs_ = function (fnName, cancelOrContext, context) {
          ...
          if (cancelOrContext && context) {
            ...
            if (typeof cancelOrContext === 'object' && cancelOrContext !== null) {
              ...
              throw new Error((0, _firebase_util__WEBPACK_IMPORTED_MODULE_2__.errorPrefix)(fnName, 'cancelOrContext') + ' must either be a cancel callback or a context object.');
            }
          }
        ...
        Object.defineProperty(Query.prototype, "ref", {
          get: function get() {
            return new _Reference(this.database, new ReferenceImpl(this._delegate._repo, this._delegate._path));
          },
          enumerable: false,
          configurable: true
        });
      ...
      function (_super) {
        ...
        Reference.prototype.transaction = function (transactionUpdate, onComplete, applyLocally) {
          ...
          var result = runTransaction(this._delegate, transactionUpdate, {
            ...
            return new TransactionResult(transactionResult.committed, new _DataSnapshot(_this.database, transactionResult.snapshot));
          });
        ...
        Reference.prototype.onDisconnect = function () {
          ...
          return new _OnDisconnect(new OnDisconnect$1(this._delegate._repo, this._delegate._path));
        };
      ...
      function () {
        ...
        Database.prototype.ref = function (path) {
          ...
          if (path instanceof _Reference) {
            var childRef = refFromURL(this._delegate, path.toString());
            return new _Reference(this, childRef);
          } else {
      ...
      function initStandalone(_a) {
        ...
        authProvider.setComponent(new _firebase_component__WEBPACK_IMPORTED_MODULE_1__.Component('auth-internal', function () {
          return customAuthImpl;
        }, "PRIVATE"
        /* PRIVATE */
        ));
        return {
          instance: new _Database(repoManagerDatabaseFromApp(app, authProvider,
          /* appCheckProvider= */
      ...
      var _ServerValue = _Database.ServerValue;

      function _registerDatabase(instance) {
        // set SDK_VERSION
        ...
        var namespace = instance.INTERNAL.registerComponent(new _firebase_component__WEBPACK_IMPORTED_MODULE_1__.Component('database', function (container, _a) {
          ...
          return new _Database(repoManagerDatabaseFromApp(app, authProvider, appCheckProvider, url), app);
        }, "PUBLIC"
        /* PUBLIC */
      ...
      _registerDatabase(_firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"]); //# sourceMappingURL=index.esm.js.map
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "DEFAULT_ID": function DEFAULT_ID() {
          return (
            /* binding */
            _DEFAULT_ID
          );
      ...
      var _DEFAULT_ID = "__googleMapsScriptId";
      /**
      ...
      var _Loader = /*#__PURE__*/function () {
         ...
         * ```
         */
        function _Loader(_ref) {
          var apiKey = _ref.apiKey,
              authReferrerPolicy = _ref.authReferrerPolicy,
              channel = _ref.channel,
              client = _ref.client,
              _ref$id = _ref.id,
              id = _ref$id === void 0 ? _DEFAULT_ID : _ref$id,
          ...
          this.client = client;
          this.id = id || _DEFAULT_ID; // Do not allow empty string
        ...
        _createClass(_Loader, [{
          ...
          get: function get() {
            if (this.errors.length) {
              return _LoaderStatus.FAILURE;
            }

            if (this.done) {
              return _LoaderStatus.SUCCESS;
            }

            if (this.loading) {
              return _LoaderStatus.LOADING;
            }

            return _LoaderStatus.INITIALIZED;
          }
        }, {
          key: "failed",
          get: function get() {
          ...
          value: function loadPromise() {
            ...
            return new Promise(function (resolve, reject) {
              _this2.loadCallback(function (err) {
                if (!err) {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      /*! @firebase/database */
      29192); //# sourceMappingURL=index.esm.js.map
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "MyOrderDetailPageModule": function MyOrderDetailPageModule() {
          return (
            /* binding */
            _MyOrderDetailPageModule
          );
        }
        /* harmony export */
      ...
      var _my_order_detail_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      ...
      var src_components_address_info_card_address_info_card_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! src/components/address-info-card/address-info-card.module */
      3673);
      /* harmony import */


      var src_components_product_list_card_product_list_card_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! src/components/product-list-card/product-list-card.module */
      33873);

      var routes = [{
        path: '',
        component: _my_order_detail_page__WEBPACK_IMPORTED_MODULE_0__.MyOrderDetailPage
      }];

      var _MyOrderDetailPageModule = /*#__PURE__*/_createClass(function MyOrderDetailPageModule() {
        _classCallCheck(this, MyOrderDetailPageModule);
      });

      _MyOrderDetailPageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_5__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_6__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_8__.IonicModule, _angular_router__WEBPACK_IMPORTED_MODULE_9__.RouterModule.forChild(routes), src_pipes_pipes_module__WEBPACK_IMPORTED_MODULE_1__.PipesModule, src_components_product_list_card_product_list_card_module__WEBPACK_IMPORTED_MODULE_3__.productListCardModule, src_components_address_info_card_address_info_card_module__WEBPACK_IMPORTED_MODULE_2__.AddressInfoCardModule],
        declarations: [_my_order_detail_page__WEBPACK_IMPORTED_MODULE_0__.MyOrderDetailPage]
      })], _MyOrderDetailPageModule);
      /***/
    },
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "MyOrderDetailPage": function MyOrderDetailPage() {
          return (
            /* binding */
            _MyOrderDetailPage
          );
      ...
      var _raw_loader_my_order_detail_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! !raw-loader!./my-order-detail.page.html */
      31698);
      /* harmony import */


      var _my_order_detail_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      ...
      var _googlemaps_js_api_loader__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      /*! @googlemaps/js-api-loader */
      73126);
      /* harmony import */


      var src_services_app_alert_app_alert_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      /*! src/services/app-alert/app-alert.service */
      20728);

      var _MyOrderDetailPage = /*#__PURE__*/function () {
        function MyOrderDetailPage(navCtrl, config, shared, appHttpService, loading, activatedRoute, appTranslationService, appUserService, appLogService, appAlertService) {
          ...
          this.order = {};
          this.countLoation = 0; //this.order = this.shared.myOrderDetialPageData;
        ...
        _createClass(MyOrderDetailPage, [{
          ...
          value: function getSingleProductDetail(id) {
            ...
            var dat = {};
            if (this.appUserService.customerData != null) dat.customers_id = this.appUserService.customerData.customers_id;else dat.customers_id = null;
            dat.products_id = id;
            ...
            this.appHttpService.postHttp(this.config.urlString + 'getallproducts', dat).then(function (data) {
              ...
              if (data.success == 1) {
                ...
                _this5.shared.singleProductPageDataArray.push(p);

                _this5.navCtrl.navigateForward("product-detail/" + p.id);
              }
            });
          }
        }, {
          key: "getShippingAddressData",
          value: function getShippingAddressData() {
            var selected = false;
            return {
          ...
          key: "getBillingAddressData",
          value: function getBillingAddressData() {
            var selected = false;
            return {
          ...
          value: function trackOrder() {
            ...
            var deliveryBoyLocationDatabase = firebase_app__WEBPACK_IMPORTED_MODULE_5__["default"].database().ref('location/' + this.order.delivery_boy_id);
          ...
          key: "loadMapAndSetMarkersThenUpdateDeliveryMarkerLocation",
          value: function loadMapAndSetMarkersThenUpdateDeliveryMarkerLocation(lat, _long) {
            var _this7 = this;

            if (this.countLoation == 0) {
              console.log(this.order);
              var loader = new _googlemaps_js_api_loader__WEBPACK_IMPORTED_MODULE_11__.Loader({
                apiKey: this.config.googleMapApiString
              });
              ...
              loader.load().then(function () {
                var marker = null;
                var deliveryBoyStartPosition = new google.maps.LatLng(lat, _long);
                var departurePosition = new google.maps.LatLng(lat, _long);
                var destinationPosition = new google.maps.LatLng(destinationLat, destinationLong); // departurePosition = new google.maps.LatLng(31.411382823495547, 73.10702210045106)
                ...
                _this7.orderMap = new google.maps.Map(document.getElementById("map"), {
                  center: {
                    lat: lat,
                    lng: _long
                  },
                ...
                _this7.orderMap.setCenter(deliveryBoyStartPosition);
              });
            } else {
              //if (this.deliveryBoyMarker) {
              var newLatLong = new google.maps.LatLng(lat, _long); // Marker does not exist - Create it
          ...
          key: "testMapLocation",
          value: function testMapLocation() {
      ...
      _MyOrderDetailPage.ctorParameters = function () {
        return [{
          ...
          type: src_services_app_alert_app_alert_service__WEBPACK_IMPORTED_MODULE_12__.AppAlertService
        }];
      };

      _MyOrderDetailPage.propDecorators = {
        content: [{
        ...
        ionRefresher: [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_15__.ViewChild,
          args: [_ionic_angular__WEBPACK_IMPORTED_MODULE_13__.IonRefresher, {
            "static": false
          }]
        }]
      };
      _MyOrderDetailPage = (0, tslib__WEBPACK_IMPORTED_MODULE_16__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_15__.Component)({
        selector: 'app-my-order-detail',
        template: _raw_loader_my_order_detail_page_html__WEBPACK_IMPORTED_MODULE_0__["default"],
        styles: [_my_order_detail_page_scss__WEBPACK_IMPORTED_MODULE_1__["default"]]
      })], _MyOrderDetailPage); //map code for show route
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = "ion-content {\n  --padding-start: var(--app-padding-left-right);\n  --padding-end: var(--app-padding-left-right);\n}\n\n#map {\n  height: 300px;\n}\n\nion-list ion-item {\n  --padding-start: 0;\n}\n\nhr {\n  width: 100%;\n  border-top: 3px solid #ebeded;\n}\n\nspan {\n  letter-spacing: -1px !important;\n}\n\n.amount ion-row {\n  line-height: 0.8;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */";
      /***/
    },
...
//# sourceMappingURL=src_app_my-order-detail_my-order-detail_module_ts-es5.js.map