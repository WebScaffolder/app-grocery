(function () {
  ...
  (self["webpackChunkrawal"] = self["webpackChunkrawal"] || []).push([["src_app_order_order_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var src_components_address_info_card_address_info_card_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      ...
      var _OrderPageModule = /*#__PURE__*/_createClass(function OrderPageModule() {
        _classCallCheck(this, OrderPageModule);
      });

      _OrderPageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_6__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_7__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_9__.IonicModule, _angular_router__WEBPACK_IMPORTED_MODULE_10__.RouterModule.forChild(routes), src_pipes_pipes_module__WEBPACK_IMPORTED_MODULE_1__.PipesModule, src_components_app_progress_bar_app_progress_bar_module__WEBPACK_IMPORTED_MODULE_2__.AppProgressBarModule, src_components_product_list_card_product_list_card_module__WEBPACK_IMPORTED_MODULE_3__.productListCardModule, src_components_address_info_card_address_info_card_module__WEBPACK_IMPORTED_MODULE_4__.AddressInfoCardModule],
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var src_services_app_http_app_http_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      ...
      var src_services_in_App_browser_in_app_browser_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! src/services/in-App-browser/in-app-browser.service */
      15326);

      var _OrderPage = /*#__PURE__*/function () {
        function OrderPage(navCtrl, appCartService, config, appHttpService, loading, appToastService, appOrderService, appUserService, inAppBrowserService) {
        ...
        _createClass(OrderPage, [{
          ...
          value: function payDirect() {
            ...
            if (this.appUserService.checkIfGuestSessionIsAvailable()) this.appOrderService.orderDetails.session_id = this.appUserService.getGuestSession();
          ...
          key: "payWithWebview",
          value: function payWithWebview() {
            var url = this.config.yourSiteUrlString + "/order-web-view";
            ...
            url += "&order_notes=";
            if (this.appCartService.couponObject) url += "&coupon_code=" + this.appCartService.couponObject.coupon_code;
          ...
          key: "stripeFormChangeEvent",
          value: function stripeFormChangeEvent() {
            var _this2 = this;

            this.stripeForm.form.valueChanges.subscribe(function (x) {
              console.log(_this2.stripeForm.form.valid);
            });
          }
        }]);
      ...
      _OrderPage = (0, tslib__WEBPACK_IMPORTED_MODULE_12__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_11__.Component)({
        selector: 'app-order',
          ...
          value: function openSite(url) {
            ...
            b.on('loadstart').subscribe(function (res) {
              if (res.url.indexOf(closeUrl) != -1) {
                ...
                _this3.navCtrl.navigateRoot("thank-you");
            ...
            b.on('exit').subscribe(function (res) {
              if (!orderPlaced) _this3.appToastService.toast("Order Cancelled");
            });
          }
        }]);
